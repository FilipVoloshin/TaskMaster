...
CREATE TABLE assigned_task_lists (
    ...
    author_id uuid NOT NULL,
    CONSTRAINT pk_assigned_task_lists PRIMARY KEY (id),
...
CREATE UNIQUE INDEX ix_assigned_task_lists_user_id_task_list_id ON assigned_task_lists (user_id, task_list_id);
...
VALUES ('20230401131649_InitialMigration', '7.0.4');

COMMIT;

START TRANSACTION;

ALTER TABLE assigned_task_lists DROP CONSTRAINT fk_assigned_task_lists_users_user_id;

ALTER TABLE assigned_task_lists RENAME COLUMN user_id TO assignee_id;

ALTER INDEX ix_assigned_task_lists_user_id_task_list_id RENAME TO ix_assigned_task_lists_assignee_id_task_list_id;

ALTER TABLE assigned_task_lists ADD CONSTRAINT fk_assigned_task_lists_users_assignee_id FOREIGN KEY (assignee_id) REFERENCES users (id) ON DELETE CASCADE;

INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
VALUES ('20230401194740_ChangedUserIdToAssigneeIdInAssignedTaskListTable', '7.0.4');

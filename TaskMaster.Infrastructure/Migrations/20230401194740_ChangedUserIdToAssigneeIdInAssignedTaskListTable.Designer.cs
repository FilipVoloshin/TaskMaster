...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskMaster.Infrastructure.Entities.AssignedTaskList", b =>
                {
                    ...
                    b.HasIndex("AssigneeId", "TaskListId")
                        .IsUnique()
                        .HasDatabaseName("ix_assigned_task_lists_assignee_id_task_list_id");
            ...
            modelBuilder.Entity("TaskMaster.Infrastructure.Entities.AssignedTaskList", b =>
                {
                    b.HasOne("TaskMaster.Infrastructure.Entities.User", "Assignee")
                        .WithMany("AssignedTaskLists")
                        .HasForeignKey("AssigneeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_assigned_task_lists_users_assignee_id");
